...
<script type="text/javascript">
  ...
  amplitude.getInstance().init("db220a67805e7640ec515a938f6b78af");
</script>`;

const yaMetrikaScript = `<!-- Yandex.Metrika counter -->
  <script type="text/javascript" >
      (function (d, w, c) {
...
const hotjarScript = `<!-- Hotjar Tracking Code for https://golangci.com/ -->
<script>
